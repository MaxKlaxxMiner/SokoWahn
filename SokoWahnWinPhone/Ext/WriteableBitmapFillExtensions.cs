...
namespace Windows.UI.Xaml.Media.Imaging
{
  ...
  public static partial class WriteableBitmapExtensions
  {
    ...
    /// <param name="y2">The y-coordinate of the bounding rectangle's bottom side.</param>
    /// <param name="color">The color.</param>
    public static void FillRectangle(this BitmapContext context, int x1, int y1, int x2, int y2, int color)
    {
    ...
    /// <param name="yr">The radius of the ellipse in y-direction.</param>
    /// <param name="color">The color for the line.</param>
    public static void FillEllipseCentered(this BitmapContext context, int xc, int yc, int xr, int yr, int color)
    {
      // Use refs for faster access (really important!) speeds up a lot!
      var pixels = context.Pixels;
      int w = context.Width;
    ...
    /// <param name="points">The points of the polygon in x and y pairs, therefore the array is interpreted as (x1, y1, x2, y2, ..., xn, yn).</param>
    /// <param name="color">The color for the line.</param>
    public static void FillPolygon(this BitmapContext context, int[] points, int color)
    {
      // Use refs for faster access (really important!) speeds up a lot!
      int w = context.Width;
      int h = context.Height;
    ...
    {
      context.FillPolygon(new[] { x1, y1, x2, y2, x3, y3, x4, y4, x1, y1 }, color);
    }
    ...
    {
      context.FillPolygon(new[] { x1, y1, x2, y2, x3, y3, x1, y1 }, color);
    }
