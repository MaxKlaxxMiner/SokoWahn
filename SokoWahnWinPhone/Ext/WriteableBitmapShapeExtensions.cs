...
namespace Windows.UI.Xaml.Media.Imaging
{
  ...
  public static partial class WriteableBitmapExtensions
  {
    ...
    public static void DrawLineBresenham(this BitmapContext context, int x1, int y1, int x2, int y2, Color color)
    {
      var col = ConvertColor(color);
      context.DrawLineBresenham(x1, y1, x2, y2, col);
    }
    ...
    /// <param name="y2">The y-coordinate of the end point.</param>
    /// <param name="color">The color for the line.</param>
    public static void DrawLineBresenham(this BitmapContext context, int x1, int y1, int x2, int y2, int color)
    {
    ...
    /// <param name="y2">The y-coordinate of the end point.</param>
    /// <param name="color">The color for the line.</param>
    public static void DrawLineDda(this BitmapContext context, int x1, int y1, int x2, int y2, Color color)
    {
      var col = ConvertColor(color);
      context.DrawLineDda(x1, y1, x2, y2, col);
    }
    ...
    /// <param name="y2">The y-coordinate of the end point.</param>
    /// <param name="color">The color for the line.</param>
    public static void DrawLineDda(this BitmapContext context, int x1, int y1, int x2, int y2, int color)
    {
      // Use refs for faster access (really important!) speeds up a lot!
      int w = context.Width;
      int h = context.Height;
    ...
    /// <param name="y2">The y-coordinate of the end point.</param>
    /// <param name="color">The color for the line.</param>
    public static void DrawLine(this BitmapContext context, int x1, int y1, int x2, int y2, Color color)
    {
      var col = ConvertColor(color);
      context.DrawLine(x1, y1, x2, y2, col);
    }
    ...
    /// <param name="y2">The y-coordinate of the end point.</param>
    /// <param name="color">The color for the line.</param>
    public static void DrawLine(this BitmapContext context, int x1, int y1, int x2, int y2, int color)
    {
    ...
    /// <param name="color">The color for the line.</param>
    /// </summary> 
    public static void DrawLineAa(this BitmapContext context, int x1, int y1, int x2, int y2, Color color)
    {
      var col = ConvertColor(color);
      context.DrawLineAa(x1, y1, x2, y2, col);
    }
    ...
    /// <param name="color">The color for the line.</param>
    /// </summary> 
    public static void DrawLineAa(this BitmapContext context, int x1, int y1, int x2, int y2, int color)
    {
