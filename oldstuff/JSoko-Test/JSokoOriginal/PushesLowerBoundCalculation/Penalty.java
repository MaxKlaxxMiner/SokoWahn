	        ...
	        while(true) {
	            ...
	            if(!board.isWallOrIllegalSquare(neighborSquarePosition)
	               ...
	               (!board.isGoal(position) ||
	                ...
	                &&
	                (board.isAccessibleBox(board.getPosition(neighborSquarePosition, UP)) &&
	                 !board.isWall(board.getPosition(neighborSquarePosition, DOWN))
	                 ||
	                 board.isAccessibleBox(board.getPosition(neighborSquarePosition, DOWN)) &&
	                 !board.isWall(board.getPosition(neighborSquarePosition, UP))
	                 ||
	                 board.isAccessibleBox(board.getPosition(position, UP)) &&
	                 !board.isWall(board.getPosition(position, DOWN))
	                 ||
	                 board.isAccessibleBox(board.getPosition(position, DOWN)) &&
	        ...
	        while(true) {
		            ...
		            if(!board.isWallOrIllegalSquare(neighborSquarePosition)
	 	               ...
	 	               (!board.isGoal(position) ||
	 	                !board.isGoal(neighborSquarePosition))
	 	                &&
	 	                (board.isAccessibleBox(board.getPosition(neighborSquarePosition, RIGHT)) &&
	 	                 !board.isWall(board.getPosition(neighborSquarePosition, LEFT))
	 	                 ||
	 	                 board.isAccessibleBox(board.getPosition(neighborSquarePosition, LEFT)) &&
	 	                 !board.isWall(board.getPosition(neighborSquarePosition, RIGHT))
	 	                 ||
	 	                 board.isAccessibleBox(board.getPosition(position, RIGHT)) &&
	 	                 !board.isWall(board.getPosition(position, LEFT))
	 	                 ||
	 	                 board.isAccessibleBox(board.getPosition(position, LEFT)) &&
