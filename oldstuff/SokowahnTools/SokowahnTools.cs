...
namespace Sokosolver.SokowahnTools
{
  ...
  public static class SokowahnStaticTools
  {
    ...
    #region # public static string LösungswegZuSteps(IEnumerable<string> lösungsweg) // wandelt einen Lösungsweg und Standard-Notation um und gibt diese mit dem Spielfeld wieder zurück
    /// <summary>
    /// wandelt einen Lösungsweg und Standard-Notation um und gibt diese mit dem Spielfeld wieder zurück
    /// </summary>
    /// <param name="lösungsweg">Lösungweg mit kompletten Spielfeldern als Lösung</param>
    /// <returns>ein Spielfeld mit Standard-Notation zum lösen</returns>
    public static string LösungswegZuSteps(IEnumerable<string> lösungsweg)
    {
      int w = 0;
      var weg = lösungsweg.Select(x =>
      {
        w = x.IndexOf('\r');
      ...
      return new SokowahnRaum(weg[0].ToArray(), w) + "\r\n" + steps + "\r\n";
    }
    #endregion
  }
  #endregion
