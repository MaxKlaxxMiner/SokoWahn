...
{
  #region # public struct SokowahnStellung // Struktur einer kompletten Stellung (inkl. Zugtiefe und Crc64-Schlüssel)
  /// <summary>
  ...
  #region # public struct SokowahnStellungRun // Struktur einer kompletten Stellung (inkl. Zugtiefe und Crc64-Schlüssel sowie gefundene Gegen-Hash Eintrag)
  /// <summary>
  /// Struktur einer kompletten Stellung (inkl. Zugtiefe und Crc64-Schlüssel sowie gefundene Gegen-Hash Eintrag)
  /// </summary>
  public struct SokowahnStellungRun
  {
    /// <summary>
    /// Spielerposition im Raum
    /// </summary>
    ...
    /// <summary>
    /// eventuell gefundener Eintrag in der entgegengesetzten Hashtabelle
    /// </summary>
    public int findHash;
